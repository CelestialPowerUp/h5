;(function () {
	...
	yangaiche(sys.load_default_module)('openid', true);
    yangaiche(sys.load_default_module)('parameter', true);
    yangaiche(sys.load_default_module)('http', true);
    yangaiche(sys.load_default_module)('user', true);
