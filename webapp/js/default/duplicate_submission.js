...
yangaiche(app.ds.disable_button, function() {
    return function(selector) {
        ...
        raw_css['border-color'] = targets.css("border-color");
        raw_css['background-color'] = targets.css("background-color");
...
yangaiche(app.ds.reset_button, function() {
    return function(selector) {
        ...
        targets.css("background-color", raw_css['background-color']);
        targets.css("border-color", raw_css['border-color']);
